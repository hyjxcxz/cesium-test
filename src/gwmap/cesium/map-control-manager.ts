...
export default class MapControlManager {
  _viewer: any
  _activeChange: any
  _measureProfileCallback: any
  _measureHelper: any
  _plottingHelper: any
  _currentControl: null
  _measureLengtheCallback: any
  ...
  active (control:any, options:any) {
   ...
   * @param {*} control2
   */
  checkIfSameGroupControl (control1:any, control2:any, options:any) {
    if (!options) {
