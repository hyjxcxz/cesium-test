...
WindEarth.ImageryLayer.getChinaLayer = function (type: any, options: any) {
...
WindEarth.ImageryLayer.getChinaProvider = function (type: string, options: { token?: any }) {
  if (!type) return null
  options = options || {}
