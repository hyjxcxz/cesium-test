...
export default class SelectControl {
  ...
  private _toolTipEntity: any
  _tooltipOption: any
  _handler: any
  _cesiumViewer: any
  _selectLinstener: any
  ...
  /**
     ...
     */
  constructor (cesiumViewer: { scene: { canvas: any } }, selectLinstener: any, options = null) {
  ...
  startSelect () {
    ...
    // 单击时进行单选
    this._handler.setInputAction(function (movement: { position: any }) {
